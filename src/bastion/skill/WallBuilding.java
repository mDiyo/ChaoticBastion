...
{
    private static final ResourceLocation one = new ResourceLocation("chaoticbastion", "textures/skill/Wall16x.png");
    private static final ResourceLocation two = new ResourceLocation("chaoticbastion", "textures/skill/Wall32x.png");
    private static final ResourceLocation three = new ResourceLocation("chaoticbastion", "textures/skill/Wall48x.png");
