...
public abstract class CKeyHandler implements ITickHandler
{
     ...
     * @param repeatings
     */
    public CKeyHandler(KeyBinding[] keyBindings, boolean[] repeatings, KeyBinding[] vanillaKeys, boolean[] vanillaRepeatings)
    {
     ...
     * @param keyBindings
     */
    public CKeyHandler(KeyBinding[] keyBindings)
    {
        this.keyBindings = keyBindings;
        this.isDummy = true;
    }
